...
const TasksBoard = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    axios
      .post("http://localhost:5000/create-task", createTaskData)
      .then(() => {
        refetch()
  ...
  return (
    <>
      <div className="grid grid-cols-12 w-full  mx-auto  ">
        <div className="col-span-12 lg:col-span-2 pl-12   bg-gradient-to-r from-blue-700 via-blue-800 to-gray-900 ">
          <div className="p-12 border-l h-full  pt-10">
            {/* Logo Text  */}
            <div>
              <h2 style={{}} className="text-4xl font-bold pb-10 text-white ">
                Taskflow
              </h2>
              <hr />
            </div>
            ...
            <div className="w-full mx-auto  ">
               <div onClick={() => setOpenModal(true)} className="flex justify-center items-center cursor-pointer">
               <IoCreateOutline className="text-3xl text-white" />
              <button
                className=" font-bold text-white p-2 mt-2 rounded-lg "
              >
                Create a Task{" "}
              </button>
               </div>
        ...
        <div className="col-span-12 md:col-span-10 flex gap-10 bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 py-10 px-10 overflow-scroll  ">
          <div className="w-1/5 min-h-screen rounded-lg border border-t-4 border-t-secondColor shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
          ...
          <div className="w-1/5 min-h-screen rounded-lg border border-t-4 border-t-primeColor  shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
            <div className="flex gap-5 justify-start ml-5 items-center">
          ...
          <div className="w-1/5 min-h-screen rounded-lg border border-t-4 border-t-green-500  shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
            <div className="flex gap-5 justify-start ml-5 items-center">
