...
const tabData = {
    Discussions: {
      ...
      imgSrc: 'https://img.freepik.com/free-photo/guy-shows-document-girl-group-young-freelancers-office-have-conversation-working_146671-13569.jpg?w=740&t=st=1705581188~exp=1705581788~hmac=aefc4eb079dd138a60822b0a438611a04834cfc79260a3fcc63c7b68d4522e4c',
    },
    Proofing: {
      ...
      imgSrc: 'https://img.freepik.com/free-photo/group-male-architect-preparing-blueprint-office_23-2147839869.jpg?w=740&t=st=1705581292~exp=1705581892~hmac=5192258fd8c5633f1017049be5a17a2ccf7af7493a3a0112b8a40c728bfccc6a',
    },
    Notes: {
      ...
      imgSrc: 'https://img.freepik.com/free-photo/close-up-people-working-office_329181-16052.jpg?w=740&t=st=1705581326~exp=1705581926~hmac=0fa32cc01a13faca5d790b0435783e7215fc2e078ac5eb1e9d8a829ed3404ecc',
    },
    Announcements: {
      ...
      imgSrc: 'https://img.freepik.com/free-psd/3d-rendering-announcement-blank-banner-background_23-2150742106.jpg?w=740&t=st=1705581392~exp=1705581992~hmac=2f930f652c75c5c85f85f9e8e5b1634a75f8ffe5482e84a7d00707a9f28132ca',
    },
    Chat: {
      ...
      imgSrc: 'https://img.freepik.com/free-photo/close-up-young-colleagues-having-meeting_23-2149060227.jpg?w=740&t=st=1705581427~exp=1705582027~hmac=52c65317922eeda4b58a9fd74c89e7a7d464f90f9edf3c9d714bf53e970c0a35',
    },
  };
    ...
    return (
      <div className="bg-gray-100 p-8 font-sans  flex items-center justify-center">
        <div className="bg-stone-50 p-6 shadow-lg rounded-xl max-w-6xl w-full mx-auto">
          <h2 className='text-center text-rose-500 font-bold uppercase tracking-wider text-sm mb-2'>Collaboration</h2>
          <h1 className='text-center text-gray-800 font-bold text-3xl mb-5'>All your team’s communication in one place</h1>
